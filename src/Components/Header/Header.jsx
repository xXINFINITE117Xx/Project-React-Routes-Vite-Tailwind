...
export const Header = () => {
  ...
  return (
    <header className='flex flex-wrap items-center justify-center w-full h-24 bg-blue-900'>
        <div className='m-4 text-2xl font-bold text-center text-white w-180 h8 hover:text-teal-200'><a href="/">Practicing Hooks</a></div>
        <NavBar style_n='container mx-auto flex items-center justify-between space-x-5'>
            <ItemNavBar style_i={styleItem} style_b={styleButton} links_a={"/"} content={"Start"}/>
